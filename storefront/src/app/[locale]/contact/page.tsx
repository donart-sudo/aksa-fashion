...
const contactMethods = [
  {
    label: "WhatsApp",
    value: "+383 49 000 000",
    description: "Fastest way to reach us — reply within minutes",
  ...
  },
  {
    ...
    description: "For formal inquiries, orders & collaborations",
    href: `mailto:${CONTACT_INFO.email}`,
    external: false,
    icon: (
      <svg className="w-4.5 h-4.5 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Mon — Sat, 10:00 — 20:00 CET",
  ...
  },
  {
    ...
    description: "Book an appointment for a private fitting",
