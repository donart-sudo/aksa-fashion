        ...
        <div className="relative flex items-center">
          ...
          <div className="relative z-10 px-5 sm:px-8 md:px-10 lg:px-16 xl:px-20 py-10 sm:py-16 lg:py-24 w-full">
            ...
            <div className="relative border-0 sm:border sm:border-white/[0.08] px-5 sm:px-8 lg:px-10 py-8 sm:py-12 lg:py-14">
              ...
              <span className="hidden sm:block absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 border-gold/40 -translate-x-px -translate-y-px" />
              <span className="hidden sm:block absolute top-0 right-0 w-6 h-6 border-t-2 border-r-2 border-gold/40 translate-x-px -translate-y-px" />
              <span className="hidden sm:block absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-gold/40 -translate-x-px translate-y-px" />
              <span className="hidden sm:block absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-gold/40 translate-x-px translate-y-px" />
              ...
              >
                <Link
                  href={`/${locale}/contact`}
                  className="inline-flex items-center justify-center gap-3 w-full sm:w-auto px-8 py-3.5 min-h-[48px] bg-gold sm:bg-white sm:hover:bg-gold text-[11px] font-bold tracking-[0.2em] uppercase text-white sm:text-charcoal sm:hover:text-white transition-all duration-300"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2.5 w-full sm:w-auto px-6 py-3.5 min-h-[48px] border border-white/15 hover:border-green-500/50 text-[11px] font-bold tracking-[0.15em] uppercase text-white/60 hover:text-green-400 transition-all duration-300"
                >
